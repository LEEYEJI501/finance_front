    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-4xl mx-auto p-10 bg-gray-900 text-green-500 shadow-2xl rounded-lg border border-green-500">
        ...
        <div className="mb-6 text-center">
          <div className="text-lg font-bold text-green-500 mb-5">
            {market}
          </div>
        ...
        <div className="mb-4 relative">
          <label htmlFor="title" className="block text-green-500 font-medium mb-2">
            제목
          </label>
          <Input
            type="text"
            ...
            maxLength={100}
          />
          <span className="absolute bottom-2 right-2 text-gray-400 text-sm">{title.length} / 100</span>
        </div>

        <div className="mb-6 relative">
          <label htmlFor="content" className="block text-green-500 font-medium mb-2">
            내용
          </label>
          <textarea
            id="content"
            ...
            maxLength={1000}
          />
          <span className="absolute bottom-2 right-2 text-gray-400 text-sm">{content.length} / 1000</span>
        </div>
